      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold mb-4">
            Get <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-blue-400">In Touch</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@recycledart.com" className="text-lg hover:text-yellow-400 transition">
                      contact@recycledart.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254700123456" className="text-lg hover:text-yellow-400 transition">
                      +254 700 123 456
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <span className="text-2xl">📍</span>
                  <div>
                    <h4 className="text-gray-400">Studio</h4>
                    <p className="text-lg">
                      Recycled Art Studio<br />
                      123 Green Street<br />
                      Nairobi, Kenya
                    </p>
                  </div>
              ...
              <div className="flex flex-wrap gap-4">
                {socialMediaLinks.map((social, index) => (
                  <motion.a
                    ...
                    href={social.url}
                    whileHover={{ y: -3 }}
                    className="flex items-center gap-2 px-4 py-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition"
                  >
            ...
            {/* Map Placeholder */}
            <div className="bg-gray-900 rounded-2xl overflow-hidden border border-gray-800 aspect-video">
